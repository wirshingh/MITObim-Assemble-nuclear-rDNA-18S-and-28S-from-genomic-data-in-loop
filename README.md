...
1. In line 14 the shell script below, modify the text "[DIGIT OF LAST ITERATION]" with the number of the last iteration run (1 less than the number entered for the flag "--end"). This number can be viewed in the names of the directories of the output files generated by MITObim (e.g., iteration3).
