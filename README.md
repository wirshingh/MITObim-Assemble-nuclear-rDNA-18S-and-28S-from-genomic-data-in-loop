...
1. In line 14 the shell script below, modify the text "[DIGIT OF LAST ITERATION]" with the number of the last iteration run. This is the number entered for the flag "--end". For example, "iteration3".
